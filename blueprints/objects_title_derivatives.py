...
def new_leasehold(particular_id):
	return render_template("create_mp_objects/new_leasehold.html",particular_id=particular_id)
...
def new_leasehold_proceed(particular_id):
	...
	params = (particular_id,current_user.id,reference_name,freehold_ID,X_location_point,y_location_point)
...
def new_cns(particular_id):
	return render_template("create_mp_objects/new_cns.html",particular_id=particular_id)
...
def newfreehold(particular_id):
	return render_template("create_mp_objects/new_mp_freehold.html",particular_id=particular_id)
...
def newfreeholdshare(particular_id):
	return render_template("create_mp_objects/new_mp_freehold_share.html",particular_id=particular_id )
