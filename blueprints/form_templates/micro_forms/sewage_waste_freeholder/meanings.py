meanings = {
    ...
    "number_propeties_served_by_shared_sewage_pipe": {
        "empty": {
            "meaning": "it has not been indicated whether the number of properties served by the shared sewage pipe has increased since the present specification of pipe was installed"
        },
        "yes": {
            "meaning": "the number of properties served by the shared sewage pipe has increased since the present specification of pipe was installed"
        },
        "no": {
            "meaning": "the number of properties served by the shared sewage pipe has not increased since the present specification of pipe was installed"
        },
        "not_known": {
            "meaning": "It is not known if the number of properties are served by the shared sewage pipe has increased since the present specification of pipe was installed"
        },
    },
    "increased_number_propeties_served_by_sewage_post_install": {
        "empty": {
            "meaning": "The discloser has not indicated by how many the number of properties served by the sewage system has increased since the design capacity was surveyed and the system was first installed"
        },
        "yes": {
            "meaning": "the number of properties served by the sewage system has increased since the design capacity was surveyed (and the system was first installed) by:"
        },
        "no": {
