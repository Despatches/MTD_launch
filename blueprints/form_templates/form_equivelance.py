equivilants = [
    ...
    {"TA6": "", "TA6_part_1": {"identifier": "postcode", "question_title": "Postcode"}},
    {
        "TA6": "",
        "TA6_part_1": {
    ...
    {"TA6": "", "TA6_part_1": {"identifier": "UPRN", "question_title": "UPRN"}},
    {
        "TA6": "",
        "TA6_part_1": {
            "identifier": "lease_or_free",
    ...
    },
    {
        "TA6": "",
        "TA6_part_1": {
            "identifier": "rent_value",
            "question_title": "How much ground rent do you pay each year? £ / year",
        },
    },
    {
        "TA6": "",
        "TA6_part_1": {
            ...
            "question_title": "Does your lease say when the rent is likely to be increased?",
        },
    },
    {
        "TA6": "",
        "TA6_part_1": {
            "identifier": "ground_rent_increase_date",
            "question_title": "Date of next increase",
        },
    },
    {
        "TA6": "",
    ...
    },
    {
        "TA6": "",
        "TA6_part_1": {
            "identifier": "last_service_charge",
            "question_title": "How much was the service charge last year (between 1 January and 31 December in £)?",
        },
    },
    {
        "TA6": "",
        "TA6_part_1": {
            "identifier": "service_charge_budget_bool",
            "question_title": "Is there a budget or known amount for the service charge this year?",
        },
    },
    {
        "TA6": "",
        "TA6_part_1": {
            "identifier": "service_charge_bill_docu",
            "question_title": "upload any relevant documents, such as a service charge bill",
        },
    },
    {
        "TA6": "",
        "TA6_part_1": {
            "identifier": "service_charge_payments_due",
            "question_title": "When are the payments due?",
        },
    },
    {
        "TA6": "",
        "TA6_part_1": {
            "identifier": "service_charge_pay_reciever",
            "question_title": "Who are payments made to?",
        },
    },
    {
        "TA6": "",
        "TA6_part_1": {
            ...
            "question_title": "Name of organisation",
        },
    },
    {
        "TA6": "",
    ...
    },
    {
        ...
        "TA6_part_1": {
            ...
            "question_title": "Building/street no",
        },
    },
    {
        "TA6": "",
    ...
    },
    {
        "TA6": "",
        "TA6_part_1": {
            "identifier": "first_to_occupy",
            "question_title": "Were you the first person to occupy the property after it was built or converted?",
        },
    },
    {
        "TA6": "",
        "TA6_part_1": {
            ...
            "question_title": "When you bought the property, you may have been given the following: copies or details of the warranties and guarantees, and  \t\t\t\t\t\t\tany planning consents or other planning documents. If available, upload or scan copies or details.",
        },
    },
    {
        "TA6": "",
        "TA6_part_1": {
            "identifier": "property_dependant",
            "question_title": "Does the proposed sale depend on you buying another property?",
        },
    },
    {
        "TA6": "",
        "TA6_part_1": {
            "identifier": "property_dependant_details",
    ...
    {"TA6": "", "TA6_part_1": {"identifier": "school_term", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "school_term_date", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "upcoming_holiday", "question_title": ""}},
    {
        "TA6": "",
        "TA6_part_1": {"identifier": "upcoming_holiday_date", "question_title": ""},
    },
    {"TA6": "", "TA6_part_1": {"identifier": "job_move", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "job_move_date", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "redundancy", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "redundancy_date", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "medical", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "medical_date", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "notice_to_tenant", "question_title": ""}},
    {
        "TA6": "",
        "TA6_part_1": {"identifier": "notice_to_tenant_date", "question_title": ""},
    },
    {"TA6": "", "TA6_part_1": {"identifier": "retirement", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "retirement_date", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "build_complete", "question_title": ""}},
    {
        "TA6": "",
        "TA6_part_1": {"identifier": "build_complete_date", "question_title": ""},
    },
    {
        "TA6": "",
        "TA6_part_1": {"identifier": "other_move_factor", "question_title": ""},
    },
    {
        "TA6": "",
        "TA6_part_1": {"identifier": "other_move_factor_date", "question_title": ""},
    },
    {
        "TA6": "",
        "TA6_part_1": {
    ...
    {"TA6": "", "TA6_part_1": {"identifier": "planning_breach", "question_title": ""}},
    {
        "TA6": "",
        "TA6_part_1": {
    ...
    {
        "TA6": "",
        "TA6_part_1": {"identifier": "bulding_reg_breach", "question_title": ""},
    },
    {
        "TA6": "",
        "TA6_part_1": {
    ...
    {"TA6": "", "TA6_part_1": {"identifier": "unfinished_work", "question_title": ""}},
    {
        "TA6": "",
        "TA6_part_1": {
    ...
    {"TA6": "", "TA6_part_1": {"identifier": "consent_lack", "question_title": ""}},
    {
        "TA6": "",
        "TA6_part_1": {
    ...
    {"TA6": "", "TA6_part_1": {"identifier": "mains_drainage", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "electricity", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "water_supply", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "gas", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "broadband", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "sewage_plant", "question_title": ""}},
    {
        "TA6": "",
        "TA6_part_1": {"identifier": "telephone_landlines", "question_title": ""},
    },
    {"TA6": "", "TA6_part_1": {"identifier": "solar_panels", "question_title": ""}},
    {"TA6": "", "TA6_part_1": {"identifier": "heat_pumps", "question_title": ""}},
    {
        "TA6": "",
        "TA6_part_1": {
    ...
    {
        "TA6": "",
        "TA6_part_1": {"identifier": "first_name_17", "question_title": "First Name"},
    },
    {
        "TA6": "",
        "TA6_part_1": {
    ...
    {
        "TA6": "",
        "TA6_part_1": {"identifier": "surname_17", "question_title": "Surname"},
    },
    {
        "TA6": "",
        "TA6_part_1": {
    ...
    {
        "TA6": "",
        "TA6_part_1": {"identifier": "knotweed", "question_title": "give details"},
    },
    {
        "TA6": "",
        "TA6_part_1": {
    ...
    {
        "TA6": "",
        "TA6_part_1": {"identifier": "mining", "question_title": "give details"},
    },
    {
        "TA6": "",
        "TA6_part_1": {
    ...
    {
        "TA6": "",
        "TA6_part_1": {"identifier": "anything_else", "question_title": "give details"},
    },
]
